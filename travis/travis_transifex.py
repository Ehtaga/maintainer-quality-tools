...
def main(argv=None):
    ...
    project_data = {"slug": transifex_project_slug,
                    ...
                    "repository_url": "http://www.transifex.com",
                    "organization": transifex_organization,
                    }
    try:
        api.projects(transifex_project_slug).get()
        ...
        try:
            ...
            print(red('Error: Authentication failed. Please verify that '
                      ...
                      'correct. If so, this project slug may be owned by '
                      'another organization. You can change these variables '
